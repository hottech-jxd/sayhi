...
namespace common.DB
{
    ...
    public class DbHelperSQLP
    {
        ...
        /// <returns></returns>
        private DataTable RunDoSplitPage(IDataParameter[] parameters, out int recordCount)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataSet dataSet = new DataSet();
        ...
        /// <returns></returns>
        public DataTable GetSplitDataTable(string strSql, int iPageSize, int iPageIndex, out int iRecordCount)
        {
