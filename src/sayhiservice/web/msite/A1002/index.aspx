<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="msite.A1002.index" %>
        ...
        <div style="text-align: center;">
            <ul style="padding: 0px;">
                <li style="float: left; width: 33%">
                    <img src="/images/1002/1-1.jpg" style="width: 100%" /></li>
                <li style="float: left; width: 33%">
                    <img src="/images/1002/2-1.jpg" style="width: 100%" /></li>
                <li style="float: left; width: 33%">
                    <img src="/images/1002/3-1.jpg" style="width: 100%" /></li>
            </ul>
        </div>
...
<script type="text/javascript">
    ...
    function goFree() {
        window.location.href = "freeIndex.aspx";
    }
