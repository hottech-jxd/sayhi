...
public class Constants {
    ...
    //定期请求打招呼任务配置数据的周期（毫秒）
    public static int  Request_SAYHI_Task_PERIOD= 1 * 60*1000;
    //打招呼的动作的间隔时间(毫秒)
     ...
     * 微信登录方式：0 手机登录
     */
    public static final String WECHAT_LOGINMODE_MOBILE="0";
    /**
     * 微信登录方式:1 其他方式登录
     */
    public static final String WECHAT_LOGINMODE_OTHER="1";
